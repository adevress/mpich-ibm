...
int MPID_VCR_Dup() __attribute__((alias("MPID_Dummy")));
int MPID_VCR_Get_lpid() __attribute__((alias("MPID_Dummy")));
int MPID_VCRT_Add_ref() __attribute__((alias("MPID_Dummy")));
int MPID_VCRT_Create() __attribute__((alias("MPID_Dummy")));
int MPID_VCRT_Get_ptr() __attribute__((alias("MPID_Dummy")));
int MPID_VCRT_Release() __attribute__((alias("MPID_Dummy")));
