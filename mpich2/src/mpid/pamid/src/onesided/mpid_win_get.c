         ...
         MPID_Win     *win)
{
  ...
  MPIU_ERR_CHKORASSERT(req->origin.dt.size == req->target.dt.size,
                       mpi_errno, MPI_ERR_OTHER, return mpi_errno, "**pamid|sizesnotsame");
 ...
 MPIU_ERR_CHKORASSERT(req->origin.dt.size == length_out, mpi_errno, MPI_ERR_OTHER, 
