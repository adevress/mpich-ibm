...
extern const char *bupc_trace_getmask();
extern const char *bupc_stats_getmask();
extern int bupc_trace_gettracelocal();
...
extern bupc_tick_t bupc_ticks_now(); /* the current tick value */
...
extern double bupc_tick_granularityus();
extern double bupc_tick_overheadus();
#endif
 ...
 */
  ...
  void          bupc_begin_accessregion();
  bupc_handle_t bupc_end_accessregion();
...
/* allow user to easily enable use of the "upc_" namespace for Berkeley extensions */
  ...
  #define upc_atomicU64_fetachadd_relaxed   bupc_atomicU64_fetachadd_relaxed
  #define upc_atomicU64_fetachadd_strict    bupc_atomicU64_fetachadd_strict
  ...
  #define upc_atomicI64_fetachadd_relaxed   bupc_atomicI64_fetachadd_relaxed
  #define upc_atomicI64_fetachadd_strict    bupc_atomicI64_fetachadd_strict
#endif
