# Compiler spec file for Intrepid GCC/UPC 3.x, stand-alone version

# upc compiler command
upc_compiler = /upc/gcc-upc/wrk/gcc/xupc -I. -Wno-implicit-function-dec -g
...
feature_list = gccupc,os_linux,cpu_i686,cc_gnu
...
known_failures = \
NPB2.4/cg-S [GCC/UPC ICE on NPB2.4 CG] | \
...
bug591 [GCC/UPC ICE in emit_move_insn] | \
bug591b [GCC/UPC ICE in emit_move_insn] | \
bug604 [GCC/UPC ICE in emit_move_insn] | \
