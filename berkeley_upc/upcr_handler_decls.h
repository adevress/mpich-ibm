/* $Id: upcr_handler_decls.h,v 1.19 2006/10/13 08:16:19 bonachea Exp $
...
UPCRI_SHORT_HANDLER(upcri_atomic_fetchandX_SRequest, 5, 7,
    (tok token, int type, uint32_t hi32, uint32_t lo32, void *addr, void *trigger),
    (token, a0, a1, a2, ptr(a3), ptr(a4)),
    (token, a0, a1, a2, ptr2(a3,a4), ptr2(a5,a6)))
 ...
 */
UPCRI_SHORT_HANDLER(upcri_SRP_setlockstate, 3, 3,
    (tok token, arg threadid, arg isblocking, arg handoffarg),
    (token, a0, a1, a2),
    (token, a0, a1, a2))

UPCRI_SHORT_HANDLER(upcri_SRQ_lockdestroy, 3, 4,
    (tok token, arg lock_threadid, arg freer_threadid, void *lock),
    (token, a0, a1, ptr(a2)), 
    (token, a0, a1, ptr2(a2,a3)))

UPCRI_SHORT_HANDLER(upcri_SRQ_freeheldlock, 4, 5,
    (tok token, arg lock_threadid, arg owner_threadid, arg freer_threadid, void *lock),
    (token, a0, a1, a2, ptr(a3)), 
    (token, a0, a1, a2, ptr2(a3,a4)))

UPCRI_SHORT_HANDLER(upcri_SRQ_lock, 3, 4,
    (tok token, arg threadid, arg isblocking, void *lock),
    (token, a0, a1, ptr(a2)), 
    (token, a0, a1, ptr2(a2,a3)))

UPCRI_SHORT_HANDLER(upcri_SRQ_unlock, 2, 3,
    (tok token, arg threadid, void *lock),
    (token, a0, ptr(a1)), 
    (token, a0, ptr2(a1,a2)))
