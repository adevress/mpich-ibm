 ...
 * $Id: upcr_err.h,v 1.29 2006/08/23 13:05:09 bonachea Exp $
 */
...
/* handoff the current #pragma pupc setting to libupcr instrumentation code, if necessary
  ...
  #define upcri_pevt_pragmahandoff()           (UPCRI_PEVT_PRAGMA = (UPCR_PRAGMA_PUPC))
  ...
  #define upcri_pevt_pragmahandoff()           (UPCRI_PEVT_PRAGMA = 0)
#else
