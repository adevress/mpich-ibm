 ...
 *
 * If sptr has been freed by a previous call to upcr_free() or does not point
 * to the beginning of a live object in shared memory, the behavior is
 * undefined. 
 *
 ...
 * by a call to upcr_free() from a _single_ thread. 
 */
