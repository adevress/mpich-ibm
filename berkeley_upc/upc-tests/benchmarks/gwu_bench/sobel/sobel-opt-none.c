 ...
 *
 * $Id: sobel-opt-none.c,v 1.1 2005/01/31 17:48:14 bonachea Exp $
 */
...
//  forall(i=NEXT_ROW(0); i<PREV_ROW(IMGSIZE); i=NEXT_ROW(i); &edge[i])	// row
  forall(i=1; i<IMGSIZE-1; i++; &edge[i].r[0])
  {
	#ifdef DEBUG
