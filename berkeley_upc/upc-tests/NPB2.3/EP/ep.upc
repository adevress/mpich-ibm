...
shared double p_sx;
shared double p_sy;
static shared double q[NQ*THREADS];  // NQ is small so no major loss in memory
...
int main(int argc, char **argv) {
  ...
  double Mops, t1, t2, t3, t4, x1, x2, sx, sy, tm, tb, an, tt, gc;
