...
int main(int argc, char* argv[])
{
    ...
    g_grids = (shared [] Grid*)upc_local_alloc(numgrid,sizeof(Grid));
    g_copy = (shared [] Grid*)upc_local_alloc(numgrid,sizeof(Grid));
    l_grids = (Grid*)malloc(numgrid*sizeof(Grid));
    l_copy  = (Grid*)malloc(numgrid*sizeof(Grid));
    data = (shared [] Real*)upc_local_alloc(10,sizeof(Real));
