...
#define SUBV0(v,u,w)            /* SUBtract Vector */                        \
{                                                                        \
    register real *_vp = (v), *_up = (u), *_wp = (w);                        \
    *_vp++ = (*_up++) - (*_wp++);                                        \
    *_vp++ = (*_up++) - (*_wp++);                                        \
...
#define SUBVT(A,v,B,u,C,w)            /* SUBtract Vector */                        \
{                                                                        \
    A *_vp = (v); \
    B *_up = (u); \
    C *_wp = (w);                        \
...
#define MULVS0(v,u,s)         /* MULtiply Vector by Scalar */                \
{                                                                        \
...
#define DOTVP0(s,v,u)                /* DOT Vector Product */                \
{                                                                        \
    register real *_vp = (v), *_up = (u);                                \
    (s)  = (*_vp++) * (*_up++);                                               \
    (s) += (*_vp++) * (*_up++);                                               \
