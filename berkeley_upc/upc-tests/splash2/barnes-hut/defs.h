...
extern double wctime();

#define CLOCK(x)  x = wctime()
 ...
 */
typedef shared struct _node* nodeptr;
typedef struct _node {
   int  type;                 /* code for node type: body or cell */
...
typedef shared  struct _body* bodyptr;
typedef shared  struct _leaf* leafptr;
typedef shared  struct _cell* cellptr;
