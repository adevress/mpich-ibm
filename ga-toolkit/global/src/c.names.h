...
#define  ga_create_handle_         GA_CREATE_HANDLE
#define  ga_set_data_              GA_SET_DATA
#define  ga_set_chunk_             GA_SET_CHUNK
...
#define  ga_create_handle_         ga_create_handle__
#define  ga_set_data_              ga_set_data__
