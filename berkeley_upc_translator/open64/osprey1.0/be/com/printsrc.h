 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/printsrc.h,v $
 *
 * Description:
 *
...
#ifdef _KEEP_RCS_ID
static const char rcs_id[] = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/printsrc.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
