...
*** $Author: ciancu $
*** $Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/dvector.h,v $
**/

#ifndef ND_RCS_ID
#define ND_RCS_ID
#ifdef _KEEP_RCS_ID
static char *dvector_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/dvector.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
#endif
