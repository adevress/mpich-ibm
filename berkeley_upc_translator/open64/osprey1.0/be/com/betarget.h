 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/betarget.h,v $
 *
...
#ifdef _KEEP_RCS_ID
static const char betarget_rcs_id[] = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/betarget.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
