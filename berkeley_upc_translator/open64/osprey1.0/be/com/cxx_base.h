 ...
 * $Author: wychen $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/cxx_base.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *cxx_basercs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/com/cxx_base.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
