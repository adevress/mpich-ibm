 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/be/be/iter.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *be_utilrcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/be/iter.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
