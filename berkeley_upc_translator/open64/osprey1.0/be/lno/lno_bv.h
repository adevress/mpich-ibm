...
*** $Author: wychen $
*** $Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/lno_bv.h,v $
*** 
*** Revision history:
***
...
#ifdef _KEEP_RCS_ID
static char *lno_bv_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/lno_bv.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif
