...
*** $Author: wychen $
*** $Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/reduc.h,v $
**/

#ifndef RED_RCS_ID
#define RED_RCS_ID
#ifdef _KEEP_RCS_ID
static char *reduc_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/reduc.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif
