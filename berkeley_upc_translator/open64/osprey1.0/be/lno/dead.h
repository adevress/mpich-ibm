...
/**
*** $Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/dead.h,v $
**/

#ifndef DEAD_RCS_ID
#define DEAD_RCS_ID
#ifdef _KEEP_RCS_ID
static char *dead = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/dead.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif
