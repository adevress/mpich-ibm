...
*** $Author: wychen $
*** $Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/model.h,v $
**/

#ifndef MD_RCS_ID
#define MD_RCS_ID
#ifdef _KEEP_RCS_ID
static char *model_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/model.h,v $ $Revision: 1.3 $";
#endif /* _KEEP_RCS_ID */
#endif
