...
// $Author: wychen $
// $Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/lego_opts.h,v $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *lego_opts_rcs_id = access_vector_INCLUDED "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/lego_opts.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
