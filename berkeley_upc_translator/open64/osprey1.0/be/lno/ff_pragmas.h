...
*** $Author: wychen $
*** $Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/ff_pragmas.h,v $
*** 
*** Description:
*** 
...
#ifdef _KEEP_RCS_ID
static char *ff_pragmas_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/be/lno/ff_pragmas.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
