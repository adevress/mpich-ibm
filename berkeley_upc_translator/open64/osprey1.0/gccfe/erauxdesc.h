 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/gccfe/erauxdesc.h,v $
 *
 * Revision history:
...
static char *eraux_desc_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/gccfe/erauxdesc.h,v $ $Revision: 1.1.1.1 $";
