...
WFE_Add_Affinity_Test(WN *while_body, WN* affinity_control_wn)
{
  ...
  if (Type_Is_Shared_Ptr(ty, true)) {
  ...
  } else if (MTYPE_is_integral(WN_rtype(affinity_control_wn))) {
    ...
    WN* mod = WN_CreateExp2(OPC_I4MOD, affinity_control_wn, threads);
    ltest = WN_CreateComma(OPR_COMMA, MTYPE_I4, MTYPE_V, tblock, mod);
