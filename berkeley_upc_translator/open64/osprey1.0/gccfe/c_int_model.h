 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/gccfe/c_int_model.h,v $
 *
 * Revision history:
 *  ??-???-92 - Original Version
 *
...
#ifdef _KEEP_RCS_ID
static char *c_int_model_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/gccfe/c_int_model.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
