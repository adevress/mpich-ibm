 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/ir_reader.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_irrcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/ir_reader.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
