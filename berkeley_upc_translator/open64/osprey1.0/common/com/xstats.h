 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/xstats.h,v $
 *
 * Description:
 *
...
#ifdef _KEEP_RCS_ID
static char *xstats_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/xstats.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
