 ...
 * $Author: wychen $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config_cache.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_cache_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config_cache.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
