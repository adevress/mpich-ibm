 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config_clist.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_clist_h_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config_clist.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
