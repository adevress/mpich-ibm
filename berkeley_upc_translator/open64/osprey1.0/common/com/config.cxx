 ...
 * Module: config.c
 * $Revision: 1.2 $
 * $Date: 2005/10/11 01:36:51 $
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config.cxx,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config.cxx,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
