 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config_promp.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_promp_h_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/com/config_promp.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
