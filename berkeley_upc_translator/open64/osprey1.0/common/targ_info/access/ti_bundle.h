 ...
 *  $Author: ciancu $
 *  $Source: /var/local/cvs/compilers/open64/osprey1.0/common/targ_info/access/ti_bundle.h,v $
 *
 *  Synopsis:
 *
...
#ifdef _KEEP_RCS_ID
static const char ti_bundle_rcs_id[] = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/targ_info/access/ti_bundle.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
