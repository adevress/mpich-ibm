...
//  $Author: ciancu $
//  $Source: /var/local/cvs/compilers/open64/osprey1.0/common/targ_info/generate/isa_pseudo_gen.h,v $

#ifndef isa_pseudo_gen_INCLUDED
#define isa_pseudo_gen_INCLUDED

#ifdef _KEEP_RCS_ID
static const char isa_pseudo_gen_rcs_id[] = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/targ_info/generate/isa_pseudo_gen.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
