...
//  $Author: ciancu $
//  $Source: /var/local/cvs/compilers/open64/osprey1.0/common/targ_info/generate/isa_subset_gen.h,v $
...
#ifdef _KEEP_RCS_ID
static char *isa_subset_gen_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/targ_info/generate/isa_subset_gen.h,v $ $Revision: 1.1.1.1 $";
#endif
#endif
