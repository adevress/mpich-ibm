 ...
 * Module: c_qtenscale:
 * $Revision: 1.2 $
 * $Date: 2005/10/11 01:36:57 $
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/c_qtenscale.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/c_qtenscale.c,v $ $Revision: 1.2 $";
