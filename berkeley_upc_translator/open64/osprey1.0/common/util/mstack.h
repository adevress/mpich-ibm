 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/mstack.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *stack_rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/mstack.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
