 ...
 * $Author: wychen $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/flags.c,v $
 *
 * Revision history:
...
static const char rcs_id[] = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/flags.c,v $ $Revision: 1.3 $";
#endif
