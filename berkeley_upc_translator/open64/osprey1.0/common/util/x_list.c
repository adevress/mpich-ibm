 ...
 *  $Author: ciancu $
 *  $Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/x_list.c,v $
 *
 *  Revision comments:
 *
...
static char *rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/x_list.c,v $ $Revision: 1.1.1.1 $";
