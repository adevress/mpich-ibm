 ...
 * $Author: wychen $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/tracing.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/tracing.c,v $ $Revision: 1.4 $";
