 ...
 *  $Author: ciancu $
 *  $Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/c_q_rel.c,v $
 *
 * =======================================================================
 * =======================================================================
 */
...
static char *rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/c_q_rel.c,v $ $Revision: 1.1.1.1 $";
