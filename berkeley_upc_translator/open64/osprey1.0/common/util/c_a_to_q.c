 ...
 * $Author: ciancu $
 * $Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/c_a_to_q.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /var/local/cvs/compilers/open64/osprey1.0/common/util/c_a_to_q.c,v $ $Revision: 1.1.1.1 $";
