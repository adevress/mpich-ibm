...
void _upcrt_finalize_1RS1(); 
int _upcrt_analyze_1RS1();
int upcrt_strips_1RS1();
void _upcrt_advance_1RS1();
...
void upcrt_add_polytope_dim(upcr_nest_descr_t nest, long depth, long lbd, long ubnd, 
			    long stride);
void* upcrt_get_local_address(upcr_nest_descr_t ln, 
...
extern void upcrt_vect_thread_init();
